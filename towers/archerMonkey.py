...
class ArcherMonkeyLong(Tower):
    def __init__(self, x, y):
        ...
        # Load archer images
        for x in range(1, 5):
            self.archer_imgs.append(pygame.transform.scale(pygame.image.load("game_assets/towers/archer_long/long_archer_" + str(x) + ".png"), (55, 55)))
    ...
    def draw(self, win):
        ...
        win.blit(archer, ((self.x + self.width/2) - (archer.get_width()/2), (self.y - archer.get_height() + (archer.get_height()/2) - 5)))
